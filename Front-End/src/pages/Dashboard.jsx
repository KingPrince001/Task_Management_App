...
function Dashboard() {
  ...
  const renderFilterComponent = () => {
    switch (activeFilter) {
      case 'category':
        return isFilterLoading ? <CircularProgress /> : <FilterByCategory />;
      case 'urgency':
        return isFilterLoading ? <CircularProgress /> : <FilterByUrgency />;
      case 'status':
        return isFilterLoading ? <CircularProgress /> : <FilterByStatus />;
      default:
